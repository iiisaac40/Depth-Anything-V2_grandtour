...
```bash
# change your `--dataset_root_dir` accordingly
python eval.py \
...
To run it in scale in cluster, refers to [metric_depth/eval_depthany_scale.py](metric_depth/eval_depthany_scale.py)
